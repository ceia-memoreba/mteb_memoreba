...
from .por.AssinSTS import *
from .por.SickBrSTS import *
from .por.Assin2STS import *
from .por_translated.PTT_BiossesSTS import *
from .por_translated.PTT_SickrSTS import *
from .por_translated.PTT_STS12STS import *
from .por_translated.PTT_STS13STS import *
from .por_translated.PTT_STS14STS import *
from .por_translated.PTT_STS15STS import *
from .por_translated.PTT_STS16STS import *
from .por_translated.PTT_STSBenchmarkSTS import *
from .por_translated.PTT_STS17Crosslingual import *
from .por_translated.PTT_STS22CrosslingualSTS import *
