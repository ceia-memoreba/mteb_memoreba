...
class PTT_MassiveScenarioClassification(MultilingualTask, AbsTaskClassification):
    metadata = TaskMetadata(
        name="PTT_MassiveScenarioClassification",
        dataset={
            "path": "pt-mteb/translated_amazon_massive_scenario",
            "revision": "main",
        },
