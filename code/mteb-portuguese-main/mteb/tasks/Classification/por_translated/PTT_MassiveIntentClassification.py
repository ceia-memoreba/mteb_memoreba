...
class PTT_MassiveIntentClassification(MultilingualTask, AbsTaskClassification):
    metadata = TaskMetadata(
        name="PTT_MassiveIntentClassification",
        dataset={
            "path": "pt-mteb/translated_amazon_massive_intent",
            "revision": "main",
        },
